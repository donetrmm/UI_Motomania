  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box sx={{
        ...
        <Button variant="outlined" color='error' sx={{ marginBottom: 3,marginTop:3 }} onClick={deletePromo}>
          Eliminar: <span style={{fontWeight:'bold'}}>{promo.id_nombre_promocion}</span>
        </Button>
      </Box>
    </Modal>
  );
